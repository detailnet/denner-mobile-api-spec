...
[Postman](https://www.getpostman.com/) settings for Denner Mobile Service.
...
- Main GitHub repository | https://raw.githubusercontent.com/detailnet/denner-mobile-api-spec/master/postman/collections/denner-mobile-api.json
- Local checkout through Protobox | http://denner-mobile-api-spec.web01.detailnet.me/postman/collections/denner-mobile-api.json
...
> To do so enter an URL instead of a file in the file selection window (e.g.: https://raw.githubusercontent.com/detailnet/denner-mobile-api-spec/master/postman/environments/denner-mobile-api_apig-test.json).
...
- Overwrite your local repository's [denner-mobile-api.json](collections/denner-mobile-api.json) file.
